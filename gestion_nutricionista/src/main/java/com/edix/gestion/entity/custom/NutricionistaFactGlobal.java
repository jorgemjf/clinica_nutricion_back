package com.edix.gestion.entity.custom;

import java.math.BigDecimal;

import com.edix.gestion.entity.Nutricionista;

public class NutricionistaFactGlobal {
	...
	public NutricionistaFactGlobal() {
		super();
	}

	public NutricionistaFactGlobal(Integer id_nutricionista, String nombre, String apellidos, BigDecimal sueldo, Long minutos_trabajados, BigDecimal facturacion_bruta,
			BigDecimal facturacion_neta, BigDecimal facturacion_bruta_hora, BigDecimal facturacion_neta_hora, Long numero_consultas) {
		super();
		nutricionista = new Nutricionista(id_nutricionista, nombre, apellidos, sueldo);
